...
## Models
***
|               Model |               Org.               |   Status    |                                                                           Availability                                                                           |               Domain               |     S-Res      |     T-Res     | Notes                    |
| ------------------: | :------------------------------: | :---------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------: | :------------: | :-----------: | ------------------------ |
|            MetNet-I |              Google              | Deprecated  |                                                                               N/A                                                                                |               CONUS                |     1x1 km     |    2-min.     |                          |
|           MetNet-II |              Google              | Deprecated  |                                                                               N/A                                                                                |               CONUS                |     1x1 km     |    2-min.     |                          |
|          MetNet-III |              Google              | Operational | Paywalled ([API](https://mapsplatform.google.com/resources/blog/hyperlocal-weather-just-got-smarter-google-maps-platforms-weather-api-now-generally-available/)) |               CONUS                |     1x1 km     |    2-min.     | \*Values from 2023 paper |
|                KNMI | Royal Netherlands Met. Institute | Operational |                                            Open ([Archive](https://dataplatform.knmi.nl/dataset/radar-forecast-2-0))                                             |   48.90-55.97° N, 0.00-10.86° E    |     1x1 km     |    5-min.     |                          |
|          Stormscope |              NVIDIA              | Operational | Open ([API](https://nvidia.github.io/earth2studio/modules/generated/models/px/earth2studio.models.px.StormScopeMRMS.html#earth2studio.models.px.StormScopeMRMS)) |               CONUS                |    ~3x3 km     |    10-min.    | No archive.              |
|       Global MetNet |              Google              | Operational |                                                                              Closed                                                                              |               Global               | ~0.05° (~5 km) |    15-min.    |                          |
|       MS-nowcasting |            Microsoft             | Operational |                                                                              Closed                                                                              |           CONUS + Europe           |     1x1 km     |    8-min.     |                          |
|                HRPN |   Japan Meteorological Agency    | Operational |                                                      Open ([Viewer](https://www.jma.go.jp/bosai/en_nowc/))                                                       |               Japan                |   250-500 m    |    5-min.     |                          |
|              RADVOR |      Deutscher Wetterdienst      | Operational |                                            Open, partial ([Open Data](https://opendata.dwd.de/weather/radar/radvor/))                                            |              Germany               |     1x1 km     |    5-min.     |                          |
| INCA-CH / NowPrecip |            MeteoSwiss            | Operational |                                  Open ([Docs](https://opendatadocs.meteoswiss.ch/e-forecast-data/e1-short-term-forecast-data))                                   | Switzerland + neighbouring regions |     1x1 km     |   5–10 min.   |                          |
|              SWIRLS |      Hong Kong Observatory       | Operational |                            Open ([data.gov.hk](https://data.gov.hk/en-data/dataset/hk-hko-rss-gridded-rainfall-nowcast-in-hong-kong))                            |   Hong Kong / Pearl River Delta    |     ~700 m     |   6-30 min.   |                          |
|             Nowcast |            MET Norway            | Operational |                                                      Open ([API](https://api.met.no/doc/nowcast/datamodel))                                                      |  Norway, Sweden, Finland, Denmark  |      N/A       |    5-min.     |                          |
|              Nimrod |            Met Office            | Deprecated  |                                    Open archive ([CEDA](https://catalogue.ceda.ac.uk/uuid/27dd6ffba67f667a18c62de5c3456350/))                                    |           UK; W. Europe            |     1-5 km     | 5-min-15 min. |                          |
|               STEPS |         Met Office / BoM         | Operational |                                                                               Open                                                                               |       UK; Australia; others        |     Varies     |   5-15 min.   |                          |
|             pySTEPS |        pySTEPS community         | Operational |                                                                               Open                                                                               |                N/A                 |      N/A       |      N/A      |                          |
|          PredRNN-v2 |             Tsinghua             | Operational |                                                    Open ([GitHub](https://github.com/thuml/predrnn-pytorch))                                                     |               China                |      ???       |      ???      |                          |
|                DGMR |         Google DeepMind          |  Research   |                                      Open ([weights](https://github.com/deepmind/deepmind-research/tree/master/nowcasting))                                      |                 UK                 |     1x1 km     |    5-min.     |                          |
...
### <img src="assets/logos/nvidia.png" height="20" align="middle" alt="">
---
...
### <img src="assets/logos/microsoft.png" height="20" align="middle" alt="">
---
...
### <img src="assets/logos/amazon.png" height="20" align="middle" alt="">
---
...
### <img src="assets/logos/ibm.png" height="20" align="middle" alt="">
---
...
### <img src="assets/logos/nasa.png" height="20" align="middle" alt="">
---
...
### <img src="assets/logos/noaa.png" height="20" align="middle" alt="">
---
